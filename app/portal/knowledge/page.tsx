...
async function getKnowledgeData(): Promise<KnowledgeData> {
  ...
  try {
    ...
    // Error fetching knowledge data - return empty defaults
    return {
      articles: [],
      categories: []
    }
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="space-y-2">
              ...
              <div className="h-4 w-64 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1">
            <div className="glass-panel rounded-lg p-6">
              <div className="h-5 w-24 bg-neutral-200 dark:bg-neutral-700 rounded mb-4 animate-pulse"></div>
              <div className="space-y-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="h-10 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                ))}
              </div>
            </div>
          </div>
